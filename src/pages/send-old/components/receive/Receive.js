...
const Receive = ({ isShowing, hide, address }) => {
    ...
    const [{ data: dataCurrencies }] = useAxios('https://api.coingecko.com/api/v3/simple/supported_vs_currencies');
                  ...
                  <div className={style['modal-wrapper']} aria-modal aria-hidden tabIndex={-1} role="dialog">
                      <div className={style['modal']}>
                          ...
                          <div className={style['modal-body']}>
                              <div>
                                  <img src={qrAddress.toDataURL('image/png')} className={style.qrCode} />
                              </div>
                              ...
                              <div>
                                  ...
                                  <input type="text" onInput={(e) => setAmount(e.target.value)} />
                              </div>
                          </div>
                      </div>
                  </div>
