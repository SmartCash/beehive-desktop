...
import { Container, FormControl, FormWrapper, FromGroup, ErrorMessage, ExportMessage, AlertMessage } from './styled';
            ...
            <FormWrapper>
                ...
                <ExportMessage>
                    ...
                    <ul>
                        ...
                        <li>
                            Você deve fazer o download de uma das carteiras abaixo, criar um novo endereco e TRANSFERIR os seus
                            fundos:
                        </li>
                        <ul>
                            <li>
                            ...
                            <li>
                                Para Desktop use (
                                <a target="_blank" rel="noopener noreferrer" href="https://smartcash.cc/wallets/">
                        ...
                        <li>
                            Reembolsos serão realizados automaticamente por SMS e ou email. Não use contas falsas ou não será
                            reembolsado em caso de erro.
                        </li>
                    </ul>
                </ExportMessage>
                ...
                <ExportMessage>
                    ...
                    <ul>
                        <li>
                            The database for this wallet will be shutting down and will be replaced with the decentralized
                            SmartHub.;
                        </li>
                        ...
                        <li>
                            Reimbursements will be automatically paid via SMS and Email, so don't fake it or you will not be
                            reimbursed.
                        </li>
                    </ul>
                </ExportMessage>
                {!data?.data ? (
                    <FromGroup onSubmit={handleSubmit(onSubmit)} autoComplete="off">
                        ...
                        <FormControl>
                            ...
                            <input type="text" name="recoverykey" ref={register({ required: 'Required' })} />
                        </FormControl>

                        {loading ? <p>Loading</p> : null}
                        {data?.error ? <ErrorMessage>Error: {data?.message}</ErrorMessage> : null}

                        <button type="submit">Export Private Key</button>
                    </FromGroup>
                ) : null}
                {data?.data && data?.message ? <AlertMessage>{data?.message}</AlertMessage> : null}
                {data?.data ? (
                    <>
                        <div className="buttonsWrapper">
                            <button className="btn" onClick={() => generatePDF(data?.data, 'SmartCash_PrivateKey')}>
